...
namespace Assignment2.AnimalFiles
{
    ...
    public class AnimalManager
    {
        ...
        public EaterType GetEaterType(int index)
        {
            return _animalList[index].GetEaterType();
        }

        public string GetFeedingSchedule(int index)
        {
            return _animalList[index].GetFoodSchedule().GetFoodSchedule();
        }

        public string GetSpecies(int index)
        {
            return _animalList[index].GetSpecies();
        }
