...
namespace Lab3
{
    public class Person
    {
        ...
        {     // Konstruktor            
            ...
            this.SName = sName;
            if (pnr[6].Equals('-'))
            {    // Tar bort - innan födelsenumren ifall det är med, underlättar med generaliserat pnr
        ...
        /**
         * 
         * Returnerar true ifall det är ett korrekt pnr, annars false
         */
        public Boolean pnrCheck()
        {
            ...
            for (int i = 0; i < this.Pnr.Length; i++)
            {
                ...
                {
                    result += tmp;             // Ojämnt ska bara plussas på
                }
            }
        ...
        /**
         * 
         * Returnerar "Man" eller "Kvinna" beroende på pnr
         */
